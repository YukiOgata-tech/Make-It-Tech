...
export default function PricingPage() {
  return (
    <div className="pt-4 pb-8 sm:py-16">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-4 grid gap-2 sm:mt-8 sm:gap-3 md:grid-cols-3 md:gap-4">
          {principles.map((p) => (
            <div
              key={p.title}
              className="flex h-full items-start gap-3 rounded-2xl border border-border/60 bg-background/70 p-3 sm:rounded-3xl sm:p-4 md:p-5"
            >
        ...
        <div className="mt-6 grid gap-2 sm:mt-8 sm:gap-3 md:grid-cols-2 md:gap-4">
          {extras.map((b) => (
            <div
              key={b.title}
        ...
        <div className="mt-4 sm:mt-8 grid gap-4 lg:grid-cols-3 lg:items-start">
          ...
          <div className="rounded-2xl border border-border/60 bg-background/70 p-3 sm:rounded-3xl sm:p-5 lg:p-6">
            ...
            {/* <div className="mt-2 flex flex-wrap gap-2 sm:mt-6 sm:gap-3">
              <Button asChild className="rounded-xl">
                <Link href="/contact">
                  無料相談へ <ArrowRight className="sm:ml-2 h-4 w-4" />
                </Link>
        ...
        {/* Final CTA */}
        <div className="mt-6 sm:mt-12 rounded-3xl border border-primary/20 bg-secondary/40 p-3 sm:p-8">
          <div className="grid gap-4 md:grid-cols-3 md:items-center">
            ...
            <div className="flex flex-wrap gap-1 sm:gap-3 md:justify-end">
              <Button asChild className="rounded-xl">
                <Link href="/contact">
                  相談する <ArrowRight className="ml-0 sm:ml-2 h-4 w-4" />
                </Link>
              </Button>
              <Button asChild variant="outline" className="rounded-xl">
                <Link href="/survey">LINEで相談</Link>
