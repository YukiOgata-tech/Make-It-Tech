    ...
    <>
      <header className="border-b border-slate-200 bg-white">
        <div className="mx-auto flex max-w-4xl items-center justify-between gap-4 px-4 py-4 sm:px-6">
          <div><p className="text-xs font-medium text-orange-600">Make It Tech</p><p className="font-semibold">契約情報入力</p></div>
      ...
      <main className="mx-auto max-w-4xl px-4 py-7 sm:px-6 sm:py-10">
        <section className="rounded-3xl border border-slate-200 bg-slate-50 p-5 sm:p-7">
          <div className="flex items-start gap-3">
            ...
            <div><p className="text-xs font-medium text-orange-700">契約情報入力のお願い</p><h1 className="mt-1 text-2xl font-semibold text-slate-950">{result.request.title}</h1><p className="mt-2 text-sm text-slate-600">{result.request.templateName}</p></div>
          </div>
