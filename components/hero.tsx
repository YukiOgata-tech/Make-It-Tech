...
function Glow() {
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      <div className="absolute -top-28 left-1/2 h-80 w-[44rem] -translate-x-1/2 rounded-full bg-gradient-to-r from-muted to-transparent blur-3xl opacity-60" />
      <div className="absolute -bottom-36 right-[-12rem] h-80 w-80 rounded-full bg-muted blur-3xl opacity-40" />
    </div>
  );
}
      ...
      <div className="mx-auto grid max-w-6xl gap-10 px-4 pb-14 sm:px-6 sm:pb-20 lg:grid-cols-2 lg:items-center lg:px-8">
        ...
        <div className="relative">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3 text-xs text-muted-foreground">
            <span className="inline-flex items-center gap-2 rounded-xl border bg-background/70 px-3 py-2">
          ...
          <Card className="rounded-3xl border bg-card/70 shadow-sm backdrop-blur">
            <CardContent className="p-6 sm:p-7">
              ...
              <div className="grid gap-3 sm:grid-cols-3">
                {trust.map((t) => (
                  <div key={t.title} className="rounded-2xl border bg-background p-4">
