...
export const SIGNER_NAME_STATEMENT_VERSION = "v1";
...
export const CONTRACT_TOKEN_DEFAULT_HOURS = 48;
export const CONTRACT_TOKEN_DEFAULT_DAYS = CONTRACT_TOKEN_DEFAULT_HOURS / 24;
...
export const CONTRACT_EVENT_TYPES = [
  ...
  "INPUT_REQUEST_SENT",
  "INPUT_REQUEST_REISSUED",
  "INPUT_REQUEST_FAILED",
  "INPUT_REQUEST_EXPIRED",
  "INPUT_PAGE_OPENED",
  "RECIPIENT_INPUT_SUBMITTED",
  "INPUT_PDF_PREVIEWED",
  "INPUT_REQUEST_CONVERTED",
  "CONTRACT_CREATED",
  "DOCUMENT_UPLOADED",
  "DOCUMENT_LOCKED",
  "MIT_ACCEPTED",
