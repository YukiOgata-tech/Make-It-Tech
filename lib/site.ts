export const site = {
  ...
  nameJa: "メイクイットテック",
  alternateNames: ["メイクイットテック", "MIT", "IT事業 MAKE IT TECH"],
  tagline: "Web制作から業務DXまで。現場で“使える”形に落とし込みます。",
  description:
    "Make It Tech（メイクイットテック）は、中小事業者・個人事業主向けに、Web制作、業務の見える化、ツール導入、自動化、簡易システム構築まで一気通貫で支援します。",
  keywords: [
    "Make It Tech", "メイクイットテック", "新潟", "山形", "DX", "IT", "業務改善", "低コスト", "安い", "丁寧", "LP制作",
